...
# ABA CONFIGURAÇÃO #
    def aba_configuracao():
        ...
        codigo_produto_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=1)
        #
        ...
        endereco_serial_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=28)
        #
        ...
        resolucao_prim_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=146)
        #
        ...
        resoluca_sec_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=176)
        ...
        fator_ajuste_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=1)
        #
        ...
        distancia_maxima_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=29)
        ...
        distancia_minima_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=60)
        ...
        coluna_em_04mA_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=90)
        ...
        coluna_em_20mA_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=120)
        ...
        offset_em_04mA_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=149)
        ...
        offset_em_20mA_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=490, y=178)        
        ...
        dump_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=850, y=29)
        ...
        limite_baixo_textbox = s.CTkEntry(frame_configuracao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=850, y=90)
        ...
        limite_alto_textbox = s.CTkTextbox(frame_configuracao, width=125, height=9, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=850, y=120)
    ...
    def aba_aplicacao():
        ...
        textbox1 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=29)
        ...
        textbox2 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=60)
        ...
        textbox3 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=90)
        ...
        textbox4 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=120)
        ...
        textbox5 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=150)
        ...
        textbox6 = s.CTkEntry(frame_aplicacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=140, y=180)
    ...
    def aba_operacao():
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=1)
        ...
        textbox12 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=30)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=60)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=90)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=160, y=120)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=635, y=1)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=635, y=30)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=635, y=60)
        ...
        textbox1 = s.CTkEntry(frame_operacao, width=125, height=23, border_width=1, corner_radius=1, fg_color="white", font=('arial bold', 12)).place(x=635, y=90)
